          ...
          <div className="-space-y-px rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="relative block w-full rounded-t-md border-0 bg-white px-3 py-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                placeholder="Email"
            ...
            <div>
              ...
              <input
                ...
                required
                className="relative block w-full rounded-b-md border-0 bg-white px-3 py-2 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
