...
var ApiError = /** @class */ (function (_super) {
    ...
    function ApiError(code, message, cause) {
        return _super.call(this, { code: code, message: message, cause: cause }) || this;
    }
    ApiError.notFound = function (resource) {
        return new ApiError('NOT_FOUND', "".concat(resource, " not found"));
    };
    ...
    ApiError.internal = function (message, cause) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        console.error('[handleErrors] Unexpected error:', error_1);
                        console.error('[handleErrors] Error stack:', error_1 instanceof Error ? error_1.stack : 'No stack');
                        console.error('[handleErrors] Error details:', JSON.stringify(error_1, null, 2));
                        // Wrap unknown errors
                        throw ApiError.internal('An unexpected error occurred', error_1);
