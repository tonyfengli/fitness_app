 ...
 */
export function getSessionUserWithBusiness(ctx: Context): SessionUser & { businessId: string } {
 ...
 */
export function getTrainerUser(ctx: Context): SessionUser & { role: 'trainer'; businessId: string } {
