import type { MessageResponse, UnifiedMessage } from "../../../types/messaging";
  ...
  async send(
    ...
    switch (message.channel) {
      ...
      case "web":
        ...
        console.log(
          `[${new Date().toISOString()}] Web response ready for client:`,
          {
      ...
      default:
        console.warn(
          `[${new Date().toISOString()}] Unknown channel for response dispatch:`,
          message.channel,
        );
    }
  }
