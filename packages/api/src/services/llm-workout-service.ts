...
import { transformLLMOutputToDB, validateExerciseLookup } from "@acme/ai";
...
export class LLMWorkoutService {
    ...
    return {
      workout: {
        ...
        description:
          ...
          `Generated by AI for ${clientName || "client"}`,
   ...
   */
  async saveWorkout(input: SaveWorkoutInput, clientName?: string) {
    // Create exercise lookup
    const exerciseLookup = await this.createExerciseLookup();
