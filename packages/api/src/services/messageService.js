...
var logger = (0, logger_1.createLogger)("MessageService");
function saveMessage(params) {
    return __awaiter(this, void 0, void 0, function () {
        var savedMessage, error_1;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    logger.info("Message saved", {
                        messageId: savedMessage === null || savedMessage === void 0 ? void 0 : savedMessage.id,
                        userId: params.userId,
                        direction: params.direction
                    });
                ...
                case 2:
                    error_1 = _a.sent();
                    logger.error("Failed to save message", error_1);
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client_1.db
                            ...
                            .where((0, db_1.eq)(schema_1.messages.userId, userId))
                ...
                case 2:
                    error_2 = _a.sent();
                    logger.error("Failed to get messages", error_2);
                    return [2 /*return*/, []];
                case 3: return [2 /*return*/];
            }
        });
