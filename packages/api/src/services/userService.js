...
var logger = (0, logger_1.createLogger)("UserService");
function getUserByPhone(phoneNumber) {
    return __awaiter(this, void 0, void 0, function () {
        var normalizedPhone, foundUser, phoneWithoutCountry, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client_1.db
                            ...
                            businessId: schema_1.user.businessId,
                ...
                case 1:
                    foundUser = _a.sent();
                    if (!(!foundUser.length && normalizedPhone.startsWith("+1"))) return [3 /*break*/, 3];
                    ...
                    return [4 /*yield*/, client_1.db
                            ...
                            .from(schema_1.user)
                            .where((0, db_1.eq)(schema_1.user.phone, phoneWithoutCountry))
                            .limit(1)];
                case 2:
                    foundUser = _a.sent();
                    _a.label = 3;
                case 3:
                    if (!!foundUser.length) return [3 /*break*/, 5];
                    return [4 /*yield*/, client_1.db
                            .select({
                            userId: schema_1.user.id,
                            businessId: schema_1.user.businessId,
                ...
                case 5:
                    if (foundUser.length && foundUser[0]) {
                        return [2 /*return*/, foundUser[0]];
                    }
                    return [2 /*return*/, null];
                case 6:
                    error_1 = _a.sent();
                    logger.error("Failed to get user by phone", error_1);
                    return [2 /*return*/, null];
