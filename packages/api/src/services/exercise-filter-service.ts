...
export interface FilterInput {
  ...
  avoidJoints?: string[];
  primaryGoal?: "mobility" | "strength" | "general_fitness" | "hypertrophy" | "burn_fat";
...
export class ExerciseFilterService {
  ...
  ): Promise<{ exercises: any[], timing?: { database: number, filtering: number } }> {
    try {
      ...
      const allExercises = await this.fetchBusinessExercises(context.businessId);
