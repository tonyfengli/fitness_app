...
export const fatigueProfile = pgEnum("fatigue_profile", [
  "low_local",
  "moderate_local",
  "high_local",
  "moderate_systemic",
...
export const primaryMuscle = pgEnum("primary_muscle", [
  "glutes",
  "quads",
  "hamstrings",
  "calves",
...
export const strengthLevel = pgEnum("strength_level", [
  "very_low",
  "low",
  "moderate",
  "high",
...
export const businessExercise = pgTable(
  "business_exercise",
  {
    id: uuid().defaultRandom().primaryKey().notNull(),
    businessId: uuid("business_id").notNull(),
...
export const userProfile = pgTable(
  ...
  (table) => [
    ...
    unique("client_profile_user_business_unique").on(
      table.userId,
      table.businessId,
    ),
  ],
