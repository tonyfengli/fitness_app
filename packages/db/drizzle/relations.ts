...
import { user, account, session, business, businessExercise, exercises, userProfile } from "./schema";
...
export const businessExerciseRelations = relations(businessExercise, ({one}) => ({
	business: one(business, {
