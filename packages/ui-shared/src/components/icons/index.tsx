...
export const ChevronLeftIcon: React.FC<SimpleIconProps> = ({ className = "w-4 h-4", size }) => {
  const sizeClass = size ? `w-${size} h-${size}` : className;
  return (
    <svg className={sizeClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const ChevronRightIcon: React.FC<SimpleIconProps> = ({ className = "w-4 h-4", size }) => {
  const sizeClass = size ? `w-${size} h-${size}` : className;
  return (
    <svg className={sizeClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const Loader2Icon = SpinnerIcon;

export const Star: React.FC<SimpleIconProps> = ({ className = "w-5 h-5", size }) => {
  const sizeClass = size ? `w-${size} h-${size}` : className;
  return (
    <svg className={sizeClass} fill="none" stroke="currentColor" viewBox="0 0 24 24">
