...
const SAVED_SCENARIOS_DIR = '/Users/tonyli/Desktop/fitness_app/saved-test-scenarios';
 ...
 */
export function saveCurrentAsScenario(name: string, description: string, notes?: string): SavedScenario | null {
...
export function generateTestFromScenario(scenarioId: string): string | null {
  ...
  const scenario = scenarios.find(s => s.id === scenarioId || s.name === scenarioId);
