...
export const FULL_BODY_BMF_TEMPLATE: WorkoutTemplate = {
  ...
  smsConfig: {
    ...
    preferencePrompt:
      "What movement patterns feel good today? Any areas to focus on or avoid?",
    followUpPrompts: {
      sessionGoal: "What's the focus - power, endurance, or movement quality?",
      muscleTargets:
        "Which movement patterns do you want to emphasize - squats, hinges, pulls?",
      intensity:
        "How are you feeling - ready to push hard or need a moderate pace?",
      avoidance: "Any movements or joints we should be careful with?",
    },
    confirmationMessage:
      "Let's do this! Your BMF workout is ready. Time to move boldly!",
...
export function getTemplatesByStrategy(
  strategy: "single-phase" | "two-phase",
): WorkoutTemplate[] {
