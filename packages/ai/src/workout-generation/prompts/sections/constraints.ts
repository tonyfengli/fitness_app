export const CONSTRAINTS_SECTION = `## Constraints
Distribute the provided total sets target across all blocks in a way that aligns with the client's session goal and preferred intensity.
...
- The total number of sets should be close to the target provided.
